      ...
      <main className="mx-auto grid min-h-[calc(100vh-73px)] max-w-7xl place-items-center px-6 py-12 lg:px-8">
        <section className="w-full max-w-md rounded-md border border-black/10 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-neutral-600">
            <LocalizedText es="Las cuentas de cliente se crean solo con Google, para mantener tu foto de perfil e identidad vinculadas de forma segura." en="Customer accounts are created only through Google, so your profile picture and identity stay linked safely." />
          </p>
          ...
          <p className="mt-4 text-center text-sm text-neutral-600">
            <LocalizedText es="¿Ya tenés acceso?" en="Already have access?" />{" "}
